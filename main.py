...
def main():
    ...
    #graph_thrust()
    #print(SLUIRP.in_dev.airbrakes_system.midair_sims.midair_sim(vehicle, 50, 300, 50))
    SLUIRP.sims.RocketPySim.multi_sim_1(angles, speeds, vehicle, "for 12 lb Design")
    #graph_OR()
